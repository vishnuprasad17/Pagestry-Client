...
const AddAddressForm = ({ onCancel, onSuccess }: AddAddressFormProps) => {
  ...
  const onSubmit = async (formData: AddAddressFormValues) => {
    try {
  ...
  const onError = (errors: FieldErrors<AddAddressFormValues>) => {
    ...
    <div className="min-h-screen bg-gray-50 py-6">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-normal text-gray-900">Add New Address</h1>
          </div>
        </div>
        ...
        <form
          ...
          <div className="px-6 py-4 bg-gray-50 border-t border-gray-200 rounded-b-lg flex gap-3">
            ...
            >
              {isLoading ? "Adding Address..." : "Save Address"}
            </button>
          </div>
        </form>
      </div>
